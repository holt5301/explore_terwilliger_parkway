...
class OnMapAndViewReadyListener(
    ...
    private fun registerListeners() {
        // View layout.
        Log.d("OnMapAndViewReadyListener", mapView.toString())
        if (mapView != null && mapView?.width != 0 && mapView?.height != 0) {
            // View has already completed layout.
            Log.d("OnMapAndViewReadyListener", "mapView already completed layout")
            isViewReady = true
        } else {
            // Map has not undergone layout, register a View observer.
            Log.d("OnMapAndViewReadyListener", "Adding global layout listener to mapview")
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        isMapReady = true
        Log.d("OnMapAndViewReadyListener", "Map is ready")
        fireCallbackIfReady()
    }
    ...
    override fun onGlobalLayout() {
        ...
        isViewReady = true
        Log.d("OnMapAndViewReadyListener", "Layout is ready")
        fireCallbackIfReady()
    }
